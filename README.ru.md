...
Текущая версия исходного кода: **1.5.3** (`versionCode 14`) · Min SDK: **26 (Android 8.0)** · Target SDK: **36**
...
- Раздел «О приложении» с описанием, установленной версией, автором, лицензией, Политикой конфиденциальности и ссылкой на репозиторий GitHub
