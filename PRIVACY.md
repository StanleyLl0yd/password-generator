...
The About screen contains links to the project's GitHub repository and software license. These links are opened externally by Android, for example in a web browser. Any data processing performed by the external application or website is governed by that service's own privacy policy.
